      ...
      if (!hasGuessed) {
        ...
        if (userGuess.toLowerCase() === currentMovie.title.toLowerCase()) {
          ...
          if (currentMovieIndex < moviesData.length - 1) {
            ...
            setHasGuessed(false)
            console.log('ShowGuessBox should be true here')
          ...
          if (lives === 1) {
            setLossMessage('You lost all your lives!')
            setShowOptions(true)
          } else {
            setLossMessage('You lost a life!')
            setShowOptions(true)
          }
        }
    ...
    const handleOptionClick = (option) => {
      ...
      if (option === 'retry') {
        ...
        if (currentMovieIndex + 1 < moviesData.length) {
          ...
          setCongratulationsMessage('Você concluiu o jogo!')
          setShowOptions(true)
        }
      }
    };
